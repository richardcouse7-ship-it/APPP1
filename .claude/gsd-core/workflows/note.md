...
- **Global scope**: `C:/Users/richa/Desktop/CompanyDataMiner/irish-b2b-website-finder/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/richa/Desktop/CompanyDataMiner/irish-b2b-website-finder/.claude/notes/`)
...
2. Glob `C:/Users/richa/Desktop/CompanyDataMiner/irish-b2b-website-finder/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/richa/Desktop/CompanyDataMiner/irish-b2b-website-finder/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/richa/Desktop/CompanyDataMiner/irish-b2b-website-finder/.claude/notes/` — works in any directory
