...
**Verification depth scales with `asvs_level`** (see @C:/Users/richa/Desktop/CompanyDataMiner/irish-b2b-website-finder/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
